...
class EVProgressView: UIView {
  ...
  var playProgress: Float? {
    willSet {
      ...
      playedTimeLabel!.text = convertToMinutes(seconds: totalTimeInSeconds! * newValue!)
      unplayedTimeLabel!.text = convertToMinutes(seconds: totalTimeInSeconds! * (1 - newValue!))
    }
  }
